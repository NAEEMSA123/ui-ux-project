...
const Pricing = () => {
  return (
    <div className="py-[48px] lg:py-[60px]">
      ...
      <p className="pt-[16px] pb-[48px] text-center text-[#36485C ] lg:text-[18px]">
        No hidden fees!
      </p>
      <div className="flex flex-col gap-y-6 gap-x-[24px]  lg:flex-row">
        <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
          ...
          <button className="mt-[16px] rounded-[4px] bg-[#FFFFFF] py-[14px] text-[#4328EB] font-medium">
            Start Trial
          </button>
        </div>
        ...
        <div className="w-full rounded-[8px] bg-[#4328EB] p-6 flex flex-col">
          <div>
            ...
            <h2 className="pt-4 text-2xl font-medium text-[#F4F8FA] ">
        ...
        <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
          <div>
            ...
            <h2 className="pt-4 text-2xl font-medium ">Custon</h2>
